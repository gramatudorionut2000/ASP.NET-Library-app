...
namespace Grama_Tudor_Ionut_Lab2.Models 
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Grama_Tudor_Ionut_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Grama_Tudor_Ionut_Lab2Context context,
