...
namespace Grama_Tudor_Ionut_Lab2.Data
{
    public class Grama_Tudor_Ionut_Lab2Context : DbContext
    {
        ...
        public DbSet<Grama_Tudor_Ionut_Lab2.Models.Author> Author { get; set; }

        public DbSet<Grama_Tudor_Ionut_Lab2.Models.Member> Member { get; set; }

        public DbSet<Grama_Tudor_Ionut_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
